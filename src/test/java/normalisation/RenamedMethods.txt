...
public class TestClass {
    ...
    public static void vfdvfdvfdvfd(String[] args) {
        kosokwsokdj("hbjjhbhjb",5);
        yytbvfnhds(null);
    }
     ...
     * @param j
     */
    static public void kosokwsokdj(String hat, int j){
     ...
     * @return
     */
    static boolean yytbvfnhds(Map<String,Integer> l){
     ...
     */
    protected void oeoeoeoeoe(){
        String brackets = "{{()}{{{";

    }

    // bcdkscd cdsjcd cdscdc -
    void mmmmmmmmmsssssssssssssssssssssshcjewcjdsjcvdsjvjjvdfvfdvfjvfsjkvfkjvf(){
    }
